...
type FibonacciClient interface {
	GetFibonacci(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *fibonacciClient) GetFibonacci(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.fibonacci/getFibonacci", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	GetFibonacci(context.Context, *Request) (*Response, error)
...
func (UnimplementedFibonacciServer) GetFibonacci(context.Context, *Request) (*Response, error) {
...
func _Fibonacci_GetFibonacci_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.fibonacci/getFibonacci",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).GetFibonacci(ctx, req.(*Request))
	}
